...
export function DigitalServiceBookletSection({
  locale,
}: DigitalServiceBookletSectionProps) {
  ...
  return (
    <section className="py-16 md:py-32 bg-gradient-to-br from-mb-black via-mb-anthracite to-mb-black relative overflow-hidden section-content-visibility">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-mb-border bg-gradient-to-br from-mb-black/80 to-mb-anthracite/60 p-8">
                ...
                <ul className="space-y-3">
                  {requirements.map((req, index) => (
                    <li
                      key={req}
                      className="flex items-start gap-3 text-mb-silver"
                    >
