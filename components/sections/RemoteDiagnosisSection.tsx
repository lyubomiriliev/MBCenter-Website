...
export function RemoteDiagnosisSection({
  locale,
}: RemoteDiagnosisSectionProps) {
  ...
  return (
    <PatternBackground className="py-16 md:py-32 bg-mb-anthracite section-content-visibility">
          ...
          <AnimatedSection from="right" delay={0.3}>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {["capability1", "capability2", "capability3"].map(
                  (cap, index) => (
                    <div
                      key={cap}
                      className="flex items-start gap-4 p-4 rounded-xl bg-mb-black/40 border border-mb-border hover:border-mb-blue/50 transition-all duration-300"
                    >
