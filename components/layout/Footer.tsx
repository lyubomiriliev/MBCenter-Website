        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-mb-silver text-sm">
              ...
              <li className="pt-2">
                <div className="font-semibold text-white mb-2 uppercase text-sm tracking-wider flex items-center gap-2">
                  <span className="w-1 h-4 bg-mb-blue flex-shrink-0"></span>
                  {t("footer.hours")}
                </div>
                <div className="text-sm">{config.hours.weekdays}</div>
                <div className="text-sm">{config.hours.weekend}</div>
              </li>
            </ul>
          </div>
        </div>
