      ...
      <PatternBackground className="pt-32 pb-32 bg-mb-black -mt-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <AnimatedSection from="bottom">
            <div className="bg-mb-anthracite p-8 lg:p-10 rounded-card border border-mb-border mb-16">
          ...
          <AnimatedSection from="bottom" delay={0.4}>
            <div className="bg-mb-anthracite rounded-card border border-mb-border overflow-hidden">
              <GoogleMap />
            </div>
          </AnimatedSection>
        </div>
