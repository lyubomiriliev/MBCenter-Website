              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="group flex items-start gap-6 p-6 bg-mb-anthracite rounded-card border border-mb-border hover:border-mb-blue transition-all duration-300">
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 bg-mb-blue/10 rounded-full flex items-center justify-center group-hover:bg-mb-blue/20 transition-colors">
                        <svg className="w-7 h-7 text-mb-blue" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg mb-2">{t('info.address')}</p>
                      <p className="text-mb-silver">{SITE_CONFIG.address.street}</p>
                      <p className="text-mb-silver">{SITE_CONFIG.address.city}, {SITE_CONFIG.address.country}</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-6 p-6 bg-mb-anthracite rounded-card border border-mb-border hover:border-mb-blue transition-all duration-300">
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg mb-2">{t('info.phone')}</p>
                      <a href={`tel:${SITE_CONFIG.phone}`} className="text-mb-blue hover:text-white transition-colors text-lg">
                        {SITE_CONFIG.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-6 p-6 bg-mb-anthracite rounded-card border border-mb-border hover:border-mb-blue transition-all duration-300">
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg mb-2">{t('info.email')}</p>
                      <a href={`mailto:${SITE_CONFIG.email}`} className="text-mb-blue hover:text-white transition-colors text-lg">
                        {SITE_CONFIG.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-6 p-6 bg-mb-anthracite rounded-card border border-mb-border hover:border-mb-blue transition-all duration-300">
                    ...
                    <div>
                      <p className="text-white font-semibold text-lg mb-2">{t('info.hours')}</p>
                      <p className="text-mb-silver text-lg">{SITE_CONFIG.hours.weekdays}</p>
                    </div>
                  </div>
                </div>
              </div>
